...
Para atingir este objetivo, foi desenvolvido um protótipo funcional baseado no microcontrolador ESP32, utilizando o sensor de corrente SCT-013-000 e o sensor de vazão YF-S201 para a coleta de dados. Além dos sensores, de forma a interagir com o usuário, foram desenvolvidas duas interfaces de usuário: uma local, composta por uma tela LCD conectada diretamente ao ESP32, e outra remota, na forma de uma aplicação \textit{web} acessível por dispositivos conectados à mesma rede que o microcontrolador. 
...
Aprimoramento do sistema    & X & X &   &   &   &   \\ \hline
Otimização do firmware      &   & X & X &   &   &   \\ \hline
Melhorias nas interfaces    &   & X & X &   &   &   \\ \hline
Coleta de dados em campo    &   &   & X & X &   &   \\ \hline
Fundamentação teórica       & X & X & X & X & X &   \\ \hline
...
%\addcontentsline{loge}{tabframed}{\protect\numberline{\thetabframed}Cronograma de atividades para TCC 2} %adiciona o quadro na lista de figuras (ERRADO)
\end{tabframed}
...
O ESP32 é um SoC de baixo custo desenvolvido pela Espressif Systems, frojetado especificamente para uma vasta gama de aplicações, desde redes de sensores de baixa potência até tarefas complexas, sendo um componente central na prototipagem e desenvolvimento de projetos de Internet das Coisas (IoT). \cite{ESPRESSIF:2016}
...
A medição e monitoramento do fluxo de água são processos importantes no gerenciamento de recursos hidricos, o que levou ao desenvolvimento de diversos metodos e ferramentas para tratar desses processos, as quais apresentam diferentes graus de viabilidade de acordo com a aplicação.

Para corpos aquaticos como rios e riachos, temos métodos como a medição por molinete, o método do flutuador, a técnica de vertedores e sensores ultrassônicos de nível, que permitem estimar a vazão com base na velocidade da corrente e na area da seção transversal do curso d’água \cite{COSTA_Camargo_Tolentino_Akutsu_Periotto_Tanaka:2023}.

Já em ambientes controlados onde os liquidos são transportados por meio de encanamentos, como em sistemas de abastecimento domestico, comercial e industrial, outros metodos podem ser aplicados, tais como hidrômetros mecânicos, sensores eletromagnéticos e sensores ultrassônicos \cite{flow:2016}.



%Em aplicações residenciais e prediais, os hidrômetros são os dispositivos mais comuns, projetados para registrar o consumo acumulado ao longo do tempo com precisão e confiabilidade. 

\subsection{YF-S201}

O sensor de vazão de água YF-S201, ilustrado na Figura~\ref{fig:YF-S201} é composto por uma turbina com um ímã acoplado e um sensor de efeito Hall. O fluxo de agua por dentro do sensor faz com que a turbina gire, o que movimenta o imã que por sua vez aciona o sensor de efeito Hall, o que, por fim, gera um numero de pulsos eletricos proporcionais ao fluxo de agua que podem ser lidos e interpretados por um sitema de controle, como um microcontrolador.
...
%A Psicologia da Conservação estuda como fatores psicológicos influenciam o comportamento humano em relação ao uso sustentável de recursos naturais. Nesse contexto, duas abordagens centrais são o eco-feedback e a teoria do nudge. 

%O eco-feedback (ou feedback ecológico) refere-se à prática de fornecer aos indivíduos informações claras, contínuas e, preferencialmente, em tempo real ou quase real sobre seu consumo de recursos, como energia elétrica, água ou gás. Esse retorno imediato permite que as pessoas percebam as consequências de suas ações, aumentando a conscientização e facilitando a autorregulação do comportamento. Estudos demonstram que o eco-feedback pode levar a reduções significativas no consumo, especialmente quando as informações são apresentadas de forma compreensível, contextualizada e associada a metas ou comparações sociais. 

%Complementarmente, a teoria do nudge (termo cunhado por Thaler e Sunstein, 2008) propõe que pequenas alterações no design do ambiente de escolha — sem restringir opções ou alterar incentivos econômicos — podem orientar as pessoas a tomar decisões mais benéficas, como o uso consciente de energia. Um nudge eficaz é sutil, previsível e respeita a liberdade de escolha. No âmbito da conservação, o eco-feedback atua como um nudge cognitivo, destacando informações relevantes que, de outra forma, permaneceriam invisíveis no cotidiano. 

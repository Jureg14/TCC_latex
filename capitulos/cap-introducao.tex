...
A sociedade moderna se depara com desafios críticos de sustentabilidade e de uso responsável dos recursos naturais. O aumento dos preços da água e da energia, e o apoio internacional à eficiência energética e à mitigação da mudança climática, intensificaram a urgência desses desafios. O espaço residencial é relevante nesse contexto, pois, embora o consumo individual seja relativamente baixo, pequenas modificações nos comportamentos em casa podem gerar, em larga escala, impactos agregados significativos e possivelmente transformadores, tanto para a sustentabilidade individual como para a sustentabilidade sistêmica.

Dentro dos lares brasileiros, o chuveiro elétrico aparece realmente como um dos maiores vilões do consumo, representando uma parte relevante da fatura de eletricidade e um ponto de alto consumo de água.

Frente a este contexto, o presente projeto foi elaborado com o objetivo de gerar um relatorio detalhado do consumo em chuveiros elétricos, conscientizando os usuários sobre o impacto de seus habitos e levando-os a desenvolver habitos mais sustentaveis.

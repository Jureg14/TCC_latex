...
Este trabalho tem por objetivo primario o desenvolvimento um sistema IoT de baixo custo para monitoramento do consumo de água e energia em chuveiros elétricos. A partir do qual uma plataforma online é desenvolvida, fornecendo ao usuário dados em tempo real, e historicos de seus banhos.

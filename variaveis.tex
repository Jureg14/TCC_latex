...
% Bacharel?
 %\program{Bacharelado em Engenharia Elétrica}
 \program{curso de Engenharia Elétrica}
 \programen{Bachelor’s Degree in Electrical Engineering}
 \degree{Bacharel}
...
% TCC2:
\colorlet{RED}{red} %parece dar erro ao remover
...
\author{JULIO CÉSAR TOLIN BORGES}  % Seu nome
\authorbib{Borges, Julio} % Seu nome para referência bibliográfica (Sobrenome, Nome)
\title{MONITORAMENTO INTELIGENTE DO CONSUMO DE ÁGUA E ENERGIA DE UM CHUVEIRO ELÉTRICO
} % Título do trabalho

%Comentar esta linha na versão final
\titleNote{ } %remover isso dá erro
...
\titleFA{MONITORAMENTO INTELIGENTE DO CONSUMO DE ÁGUA E ENERGIA DE UM CHUVEIRO ELÉTRICO}

\titleen{INTELLIGENT MONITORING OF WATER AND ENERGY CONSUMPTION OF AN ELECTRIC SHOWER} % Título traduzido para inglês
\advisor{Prof. Dr. Marcelo Favoretto Castoldi.} % Nome do orientador. Lembre-se de prefixar com "Prof. Dr.", "Profª. Drª.", "Prof. Me." ou "Profª. Me."}
% Se não houver corientador, comente a linha a baixo
\coadvisor{Prof. Dr. Wesley Angelino de Souza.} % Nome do coorientador, caso exista. Caso não exista, comente a linha.
...
\address{Cornélio Procopio}
\addressen{Campus Cornélio Procópio, PR, Brazil}
\documenttype{Monografia}
\documenttypeen{Monograph}
\degreetype{Graduação}

\evalboardmember{Ruhan Pontes Policarpo de Souza 
}{Doutorado em Engenharia Elétrica}{Universidade Tecnológica Federal do Paraná}
\evalboardmember{Gabriel Távore de Arruda
}{Engenheiro}{Universidade Tecnológica Federal do Paraná}
...
\PalavraChaveA{Internet das Coisas (IoT)}%% Palavra-chave A
\PalavraChaveB{efici\^encia energ\'etica}%% Palavra-chave B
\PalavraChaveC{monitoramento em tempo real}%% Palavra-chave C
\PalavraChaveD{sistema embarcado}%% Palavra-chave D
\PalavraChaveE{chuveiro el\'etrico}%% Palavra-chave E
...
\KeywordA{Internet of Things (IoT)}%% Keyword A
\KeywordB{energy efficiency}%% Keyword B
\KeywordC{real-time monitoring}%% Keyword C
\KeywordD{embedded system}%% Keyword D
\KeywordE{electric shower}%% Keyword E

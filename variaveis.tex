...
\coadvisor{Prof. Wesley Angelino de Souza.} % Nome do coorientador, caso exista. Caso não exista, comente a linha.
...
\evalboardmember{Arthur Carvalho Santos
}{Titulação (Especialização, Mestrado, Doutorado)}{Universidade Tecnológica Federal do Paraná}
...
\PalavraChaveB{conserva\c{c}\~ao de recursos}%% Palavra-chave B
\PalavraChaveC{sistemas embarcados}%% Palavra-chave C
\PalavraChaveD{casa inteligente}%% Palavra-chave D
\PalavraChaveE{consumo consciente}%% Palavra-chave E
...
\KeywordB{resource conservation}%% Keyword B
\KeywordC{embedded systems}%% Keyword C
\KeywordD{smart home}%% Keyword D
\KeywordE{conscious consumption}%% Keyword E
